...
public class EmailAFriendPage extends Utils {
    private final By _emailFriendField = By.id("FriendEmail");
    private final By _yourEmailAddressField = By.xpath("//input[@placeholder=\"Enter your email address.\"]");
    private final By _personalMessageField = By.id("PersonalMessage");
    private final By _sendEmail = By.name("send-email");
